...
export default function FicheirosReuniaoOpCreate() {
    ...
    function SendSave() {
        if (campFicheiro === "") {
            ...
            const baseUrl = "https://pint-backend.onrender.com/ficheiros/reunioes/"+reuniaoId+"/oportunidades/"+oportunidadeId+"/create";
            ...
            .then((response) => {
                ...
                else
                {
                    ...
                    navigate("/backoffice/oportunidades/"+oportunidadeId+"/reunioes/"+reuniaoId+"/ficheiros")
                } 
            })
            .catch((error) => {
