...
export default function FicheirosInteracaoCreate() {
    ...
    function SendSave() {
        if (campFicheiro === "") {
            ...
            const baseUrl = "https://pint-backend.onrender.com/ficheiros/interacoes/"+interacaoId+"/contactos/"+contactoId+"/oportunidades/"+oportunidadeId+"/create";
            ...
            .then((response) => {
                ...
                else
                {
                    ...
                    navigate("/backoffice/oportunidades/"+oportunidadeId+"/contactos/"+contactoId+"/interacoes/"+interacaoId+"/ficheiros")
                }
            })
            .catch((error) => {
