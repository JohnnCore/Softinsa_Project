...
export default function NotasCreate() {
    ...
    function SendSave() {
        if (campTitulo === "") {
            ...
            const baseUrl = "https://pint-backend.onrender.com/notas/interacoes/" + interacaoId + "/contactos/" + contactoId + "/oportunidades/" + oportunidadeId + "/create";
            const datapost = {
                titulo: campTitulo,
