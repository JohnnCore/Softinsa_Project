...
export default function NotasEntrevistasCreate() {
    ...
    function SendSave() {
        if (campTitulo === "") {
            ...
            const baseUrl = "https://pint-backend.onrender.com/notas/entrevistas/" + entrevistaId + "/candidaturas/" + candidaturaId + "/ofertas/" + ofertaId + "/create";
            const datapost = {
                titulo: campTitulo,
