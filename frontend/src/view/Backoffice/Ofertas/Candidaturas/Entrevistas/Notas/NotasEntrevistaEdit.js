...
export default function NotasEntrevistaUpdate() {
    const navigate = useNavigate()

    const [isLoading, setIsLoading] = useState(true);

    const { ofertaId, candidaturaId, entrevistaId, notaId } = useParams();
    ...
    useEffect(() => {
        const LoadNota = () => {
            const url = "https://pint-backend.onrender.com/notas/get/" + notaId + "/entrevistas/" + entrevistaId + "/candidaturas/" + candidaturaId + "/ofertas/" + ofertaId
        ...
        LoadNota()
    }, [notaId, candidaturaId, entrevistaId, ofertaId]);
    ...
    function SendUpdate() {
        if (campTitulo === "") {
            ...
            const baseUrl = "https://pint-backend.onrender.com/notas/update/" + notaId + "/entrevistas/" + entrevistaId + "/candidaturas/" + candidaturaId + "/ofertas/" + ofertaId
            ...
            axios.post(baseUrl, datapost, { headers: authHeader() })
                .then(response => {
                    if (response.data.success === false) {
                        ...
                        navigate('/backoffice/ofertas/' + ofertaId + '/candidaturas/' + candidaturaId + '/entrevistas/' + entrevistaId + "/notas")
                    }
                })
                .catch((error) => {
        ...
        <div className='tabela-centro'>
            <nav aria-label="breadcrumb">
                <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item"><Link to={"/backoffice/ofertas/" + ofertaId + "/candidaturas/" + candidaturaId + "/entrevistas/" + entrevistaId + "/notas"}>Notas</Link></li>
