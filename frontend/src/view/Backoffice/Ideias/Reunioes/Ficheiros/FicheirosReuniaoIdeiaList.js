...
export default function FicheirosReuniaoIdeiaListBO(){
    ...
    function LoadFicheirosReuniaoIdeiaBO() {
        const url = "https://pint-backend.onrender.com/ficheiros/reunioes/"+reuniaoId+"/ideias/"+ideiaId+"/list"
    ...
    function LoadFillData(){
        ...
        return sortedData.map((data)=>{ 
            const downloadUrl = `https://pint-backend.onrender.com/ficheiros/reunioes/${reuniaoId}/ideias/${ideiaId}/file/${data.ficheiro}`
    ...
    return (
        <div className="tabela-centro">
            ...
            <ul className="nav nav-pills nav-fill">
                ...
                <li className="nav-item">
                    <Link className="nav-link active" aria-current="page" to={"/backoffice/ideias/" + ideiaId + "/reunioes/"+reuniaoId+"/ficheiros"}>Ficheiros</Link>
                </li>
            </ul>
            <Link className="btn_adicionar " to={"/backoffice/ideias/"+ideiaId+"/reunioes/"+reuniaoId+"/ficheiros/create"}>Criar Nova</Link>
            {isLoading? (
